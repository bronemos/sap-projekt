...
Promotrimo najprije ovisnost frekventnosti kriminalnih aktivnosti o trenutku u danu (sat po sat).\
...
```{r fig.cap = "Frekventnost kriminalnih radnji u periodu od 24 sata"}
hist(
  hours + 1,
  breaks = 0:24,
...
U nastavku možemo vidjeti da je su najčešći lakši oblici zločina što je bilo i za očekivati.
```{r}
...
Promotrimo li kategorije zločina koje s frekvencijama manjim od 2000 uočavamo možemo vidjeti međusoban odnos frekventnosti težih kriminalnih radnji.
```{r}
dfs <- df[df$Freq < 2000, ]
...
U nastavku možemo vidjeti graf koji prikazuje relativan odnos frekventnosti krađa i ubojstava u periodu od 24 sata.\
...
Promatranjem odnosa stope ubojstava i BDP per Capita uočavamo da su stope ubojstava znatno veće u područjima nižeg BDP per Capita.\
