...
Promatranjem kretanja broja krađa i kriminala povezanog s narkoticima (Figure \ref{fig:theft_vs_narcotics}) može se uočiti da se broj krađa i broj kriminalnih djela povezanih s narkoticima podjednako mijenjaju. Izgleda kao da brojka obje vrste kriminalnih djela istovremeno pada odnosno raste.

```{r theft_vs_narcotics, fig.cap = "Odnos stope krađa i BDP per Capita", out.width='0.9\\linewidth'}
...
plot(
  theft_dates,
  type = "l",
  main = "Comparison of rnumber of crimes related to theft and narcotics in a year",
  xlab = "Date",
  ylab = "Number of crimes",
)
lines(theft_dates, col = "red")
lines(narcotics_dates, col = "blue")
legend("bottomright", c("Theft", "Narcotics"), fill = c(rgb(1, 0, 0, 0.5), rgb(0, 0, 1, 0.5)))
