...
plot(
  theft_dates,
  type = "l",
  main = "Criminal acts fall during lockdown",
  xlab = "Date",
...
Kategorija kriminala koju promatramo je Firearm.related. Prvo ćemo napraviti korelacijsku matricu da dobijemo dojam kako se brojke kreću i od kojih varijabli bismo mogli krenuti raditi regresijski model.
