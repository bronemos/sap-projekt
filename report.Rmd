...
plot(reg, 3)
```
Horizontalna linija je dobar znak da homogenost varijance vrijedi. Svejedno idemo testirati pomoću ncvTesta (Non-Constant Error Variance Test) čija je nul hipoteza da su varijance konstantne.
...
ncvTest(reg)
```
Model prolazi test na razini značajnosti 0.05.
